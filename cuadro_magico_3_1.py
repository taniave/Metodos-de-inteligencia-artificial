...
for i in range(gen):
	...
	if((index_max < n) and (index_min < n)): #maximo y minimo en fila
		...
		col3=random.randint(0,n-1)

		temp = nuevo[pos_max][col]
		nuevo[pos_max][col] = nuevo[pos_min][col1]
		nuevo[pos_min][col1] = temp

		tmp = nuevo[pos_max][col2]
		nuevo[pos_max][col2] = nuevo[pos_min][col3]
		nuevo[pos_min][col3] = tmp
		...
		fil3=random.randint(0,n-1)
		
		tmp = nuevo[fil2][pos_max]
		nuevo[fil2][pos_max] = nuevo[fil3][pos_min]
		nuevo[fil3][pos_min] = tmp
		...
		tmp = nuevo[pos_max][col1]
		nuevo[fil1][pos_min] = nuevo[pos_max][col1]
		nuevo[pos_max][col1] = tmp
		...
		tmp = nuevo[fil1][pos_max]
		nuevo[fil1][pos_max] = nuevo[pos_min][col1]
		nuevo[pos_min][col1] = tmp
